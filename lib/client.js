            ...
            /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)("div", { className: css3.toolbar, children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)("div", { className: css3.dropWrap, children: [
                /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)(
                  ...
                  {
                    type: "button",
                    className: css3.presetPill,
                    "aria-haspopup": "menu",
                    "aria-expanded": openMenu === "preset",
                    onClick: () => {
                      setOpenMenu((value) => value === "preset" ? null : "preset");
                    },
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(TagIcon, {}),
                      /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("span", { className: css3.presetPillLabel, children: activePreset === ALL_PRESETS ? t("presetAllName") : presets.find((preset) => preset.id === activePreset)?.name ?? activePreset }),
                ...
                openMenu === "preset" && /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)(import_jsx_runtime31.Fragment, { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("button", { type: "button", className: css3.bulkOverlay, "aria-label": t("close"), onClick: () => {
                    setOpenMenu(null);
                  } }),
                  /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)("div", { className: css3.dropMenu, role: "menu", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)(
                      "button",
                      {
                        type: "button",
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("span", { className: css3.dropCheck, "data-on": activePreset === ALL_PRESETS || void 0, "aria-hidden": "true", children: activePreset === ALL_PRESETS ? "\u2713" : "" }),
                          t("presetAllName")
                        ]
                      }
                    ),
                    presets.map((preset) => {
                      ...
                      return /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)(
                        "button",
                        {
                          ...
                          className: css3.dropItem,
                          "aria-checked": active,
                          title: [label, preset.id, preset.isDefault === true ? t("presetDefaultTag") : "", count > 0 ? t("presetOverrideCount", { n: count }) : ""].filter(Boolean).join(" \xB7 "),
                          onClick: () => {
                            setActivePreset(preset.id);
                            setOpenMenu(null);
                          },
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("span", { className: css3.dropCheck, "data-on": active || void 0, "aria-hidden": "true", children: active ? "\u2713" : "" }),
                            label,
                            count > 0 && /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("span", { className: css3.dropBadge, children: count })
                          ]
                        },
                        preset.id
                      );

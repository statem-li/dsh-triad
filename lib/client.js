...
var import_react24, import_dsh_client_ui_primitives4, import_jsx_runtime27;
...
function UsageTab({ range, rangeLabel, refreshTick }) {
  ...
  const [selectedDay, setSelectedDay] = (0, import_react17.useState)(null);
  ...
  (0, import_react17.useEffect)(() => ensureSearchStyle(), []);
  if (error) {
...
function SignalTab() {
  const [signal, setSignal] = (0, import_react18.useState)(null);
  const [error, setError] = (0, import_react18.useState)(null);
  const [retryTick, setRetryTick] = (0, import_react18.useState)(0);
  const [openDate, setOpenDate] = (0, import_react18.useState)(null);
  const [dayRows, setDayRows] = (0, import_react18.useState)(null);
  const [dayLoading, setDayLoading] = (0, import_react18.useState)(false);
  const [dayError, setDayError] = (0, import_react18.useState)(null);
  const [budgetDraft, setBudgetDraft] = (0, import_react18.useState)("");
  const [budgetSaving, setBudgetSaving] = (0, import_react18.useState)(false);
  const [budgetNote, setBudgetNote] = (0, import_react18.useState)(null);
...
function AccountsTab({ refreshTick }) {
  const [providers, setProviders] = (0, import_react21.useState)([]);
  const [credentialFor, setCredentialFor] = (0, import_react21.useState)(null);
  const [refreshing, setRefreshing] = (0, import_react21.useState)(false);
  const [error, setError] = (0, import_react21.useState)(null);
  const [refreshKey, setRefreshKey] = (0, import_react21.useState)(0);
  const [visibility, setVisibility] = (0, import_react21.useState)({});
  const load = () => {
    setError(null);
  ...
  const report = (0, import_react21.useCallback)((id) => (visible) => {
...
function RangePicker({ preset, custom, onChangePreset, onChangeCustom }) {
  ...
  (0, import_react22.useEffect)(() => ensureStyle(), []);
...
function Workbench({ onClose, closing = false, anchor = null, onCardMouseEnter, onCardMouseLeave, renderTab }) {
  const [tab, setTab] = (0, import_react23.useState)("trend");
  const [preset, setPreset] = (0, import_react23.useState)("today");
  const [custom, setCustom] = (0, import_react23.useState)(null);
  const close = onClose ?? (() => {
  });
...
function SkillsPanel({ onClose, closing = false, anchor = null, onCardMouseEnter, onCardMouseLeave }) {
  ...
  const [reload, setReload] = (0, import_react25.useState)(0);
  const [expanded, setExpanded] = (0, import_react25.useState)(/* @__PURE__ */ new Set());
  const [viewer, setViewer] = (0, import_react25.useState)(null);
  const [assignTarget, setAssignTarget] = (0, import_react25.useState)(null);
  const [newBundleOpen, setNewBundleOpen] = (0, import_react25.useState)(false);
  const [newBundleName, setNewBundleName] = (0, import_react25.useState)("");
  const [creatingBundle, setCreatingBundle] = (0, import_react25.useState)(false);
  const [renameTarget, setRenameTarget] = (0, import_react25.useState)(null);
  const [renaming, setRenaming] = (0, import_react25.useState)(false);
  const [confirm, setConfirm] = (0, import_react25.useState)(null);
  const [confirming, setConfirming] = (0, import_react25.useState)(false);
  const [install, setInstall] = (0, import_react25.useState)(null);
  const [installName, setInstallName] = (0, import_react25.useState)("");
  const [installDescription, setInstallDescription] = (0, import_react25.useState)("");
  const [installBundleId, setInstallBundleId] = (0, import_react25.useState)(void 0);
  const [installing, setInstalling] = (0, import_react25.useState)(false);
  const [installError, setInstallError] = (0, import_react25.useState)(null);
  const [dropActive, setDropActive] = (0, import_react25.useState)(false);
  const fileInput = (0, import_react25.useRef)(null);
  const [toggles, setToggles] = (0, import_react25.useState)({ skills: {}, bundles: {} });
  const [toggling, setToggling] = (0, import_react25.useState)(/* @__PURE__ */ new Set());
  const [presets, setPresets] = (0, import_react25.useState)([]);
  const [overrides, setOverrides] = (0, import_react25.useState)({});
  const [activePreset, setActivePreset] = (0, import_react25.useState)(ALL_PRESETS);
  const refresh = () => {
          ...
          state.status === "ready" && /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(import_jsx_runtime28.Fragment, { children: [
            ...
            bundles.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("p", { className: css3.status, children: t("bundlesEmpty") }) : /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("ul", { className: css3.bundleList, children: bundles.map((bundle) => {
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("li", { className: css3.bundle, "data-open": open2 ? "true" : void 0, children: [
                ...
                renamingThis && renameTarget !== null && /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("form", { className: `${css3.inlineForm} ${css3.inlineFormBlock}`, onSubmit: (event) => {
...
function UsageWorkbenchEntry() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)(import_jsx_runtime29.Fragment, { children: [
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(ErrorBoundary, { label: "\u7528\u91CF\u5DE5\u4F5C\u53F0", fallback: null, onError: requestClose, children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(Workbench, { closing, onClose: requestClose, anchor }) })
  ] });
}
function SkillsEntry() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)(import_jsx_runtime29.Fragment, { children: [
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(ErrorBoundary, { label: "\u6280\u80FD\u9762\u677F", fallback: null, onError: requestClose, children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(SkillsPanel, { closing, onClose: requestClose, anchor }) })
  ] });
}

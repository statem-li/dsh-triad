...
.dsh-month-cell {
  ...
  cursor: pointer;
  opacity: 0;
  animation: dsh-month-cell-in 320ms cubic-bezier(0.2, 0.8, 0.2, 1) backwards;
...
function usageStats(usage, now = Date.now()) {
  if (usage === null) return null;
  const days = usage.days ?? [];
  const hours = usage.hours ?? [];
  const todayKey = localDayKey(now);
  const todayReq = hours.filter((h) => h.hour.startsWith(todayKey)).reduce((acc, h) => acc + (h.requests ?? 0), 0);
  const weekStartKey = localDayKey(now - 6 * 864e5);
  const weekReq = days.filter((d) => d.date >= weekStartKey).reduce((acc, d) => acc + (d.requests ?? 0), 0);
  let lastActive = null;
  for (let i = days.length - 1; i >= 0; i -= 1) {
    if ((days[i]?.tokens ?? 0) > 0) {
  ...
  let lastText = "\u6682\u65E0\u8BB0\u5F55";
  if (lastActive !== null) {
    const dayStart = (/* @__PURE__ */ new Date(`${lastActive}T00:00:00`)).getTime();
    const days2 = Math.max(0, Math.round((now - dayStart) / 864e5));
    lastText = days2 <= 0 ? "\u4ECA\u5929" : `${days2} \u5929\u524D`;
  }
  return { todayReq, weekReq, lastText };
}
var labelStyle = { fontSize: 11, lineHeight: "16px", color: "var(--dsw-alias-label-tertiary)", whiteSpace: "nowrap" };
function AccountDrawer({ provider, account, usage, index, closing, onClose, onJumpDetail, onManage }) {
  ...
  const statusLabel = provider.status === "ok" ? "\u6B63\u5E38\u8FD0\u884C" : provider.status === "critical" ? "\u7D27\u6025" : provider.status === "warning" ? "\u8B66\u544A" : provider.status === "not-configured" || provider.status === "unauthorized" ? "\u672A\u914D\u7F6E" : provider.status === "pending" ? "\u7B49\u5F85" : "\u672A\u77E5";
  const statusColor = provider.status === "ok" ? "var(--dsw-alias-state-success-primary)" : provider.status === "critical" ? "var(--dsw-alias-state-error-primary)" : provider.status === "warning" ? "var(--dsw-alias-state-warn-primary)" : provider.status === "pending" ? "var(--dsw-alias-label-tertiary)" : "var(--dsw-alias-state-warn-primary)";
  ...
  const divider = { height: 1, background: "var(--dsw-alias-border-l1)", margin: "12px 0" };
  const outBtn = {
    flex: 1,
    display: "flex",
    alignItems: "center",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { className: "dsh-acc-drawer-wrap", "data-closing": closing, children: /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("aside", { className: "dsh-acc-drawer", "data-closing": closing, "aria-label": `${provider.displayName} \u8BE6\u60C5`, children: [
    /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 10, padding: "14px 16px", borderBottom: "1px solid var(--dsw-alias-border-l1)", flex: "none" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "dsh-acc-logo", style: { background: `color-mix(in srgb, ${color} 16%, transparent)`, color }, children: initial }),
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { style: { flex: 1, minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontSize: 14, fontWeight: 600, color: "var(--dsw-alias-label-primary)" }, children: provider.displayName }),
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(
        "button",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("svg", { width: "13", height: "13", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("path", { d: "M4 4l8 8M12 4l-8 8", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round" }) })
        }
      )
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", padding: "12px 16px 0" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "dsh-acc-dot", style: { background: statusColor, color: statusColor } }),
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { style: { fontSize: 12.5, fontWeight: 600, color: statusColor }, children: statusLabel }),
      isPool && /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "dsh-acc-chip", style: { color: "var(--dsw-alias-state-business-primary)", background: "color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent)" }, children: "\u79EF\u5206\u6C60" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { style: { padding: "2px 16px 0", fontSize: 11, lineHeight: "18px", color: "var(--dsw-alias-label-tertiary)" }, children: [
      hasPlan ? account.plan : provider.accountMode === "balance" ? "\u4F59\u989D\u5236" : provider.accountMode === "subscription" ? "\u8BA2\u9605\u5236" : "\u6682\u65E0\u65B9\u6848",
      modelCount !== null && ` \xB7 ${modelCount} \u4E2A\u6A21\u578B`
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { style: { flex: 1, minHeight: 0, overflowY: "auto", padding: "12px 16px" }, children: [
      !mounted || account === null ? /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: [0, 1].map((i) => /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { className: "dsh-acc-skel", style: { height: 64 } }, i)) }) : isPool ? /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(PoolQuotaPanel, { windows, plan: account.plan }) : windows.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: windows.map((w, wi) => /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(QuotaWindowRow, { window: w, delay: wi * 60, active: mounted }, w.kind)) }) : /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { style: { fontSize: 12, lineHeight: "20px", color: "var(--dsw-alias-label-tertiary)" }, children: "\u6682\u65E0\u65B9\u6848\u4FE1\u606F" }),
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { style: divider }),
      /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { style: { borderRadius: 12, padding: "10px 12px", display: "flex", alignItems: "center", gap: 10, background: "color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, var(--dsw-alias-bg-layer-1))" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "dsh-acc-kpi-icon", style: { width: 32, height: 32, borderRadius: 9, background: "color-mix(in srgb, var(--dsw-alias-state-business-primary) 14%, transparent)", color: "var(--dsw-alias-state-business-primary)" }, children: /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: [
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("rect", { x: "1.5", y: "1.5", width: "5.4", height: "5.4", rx: "1.4", stroke: "currentColor", strokeWidth: "1.4" }),
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("rect", { x: "9.1", y: "1.5", width: "5.4", height: "5.4", rx: "1.4", stroke: "currentColor", strokeWidth: "1.4" }),
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("rect", { x: "1.5", y: "9.1", width: "5.4", height: "5.4", rx: "1.4", stroke: "currentColor", strokeWidth: "1.4" }),
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("rect", { x: "9.1", y: "9.1", width: "5.4", height: "5.4", rx: "1.4", stroke: "currentColor", strokeWidth: "1.4" })
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { style: { flex: 1, minWidth: 0, display: "flex", flexDirection: "column", gap: 1 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { style: labelStyle, children: "\u53EF\u7528\u6A21\u578B" }),
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { style: { fontSize: 15, fontWeight: 600, color: "var(--dsw-alias-label-primary)", fontFamily: "ui-monospace, SFMono-Regular, Menlo, monospace" }, children: modelCount !== null ? `${modelCount} \u4E2A` : "\u2014" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(
          "button",
          {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { style: { marginTop: 12, display: "flex", flexDirection: "column", gap: 2 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { style: sectionTitle, children: "\u6700\u8FD1\u6D3B\u52A8" }),
        /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { style: { display: "flex", flexDirection: "column", paddingTop: 8 }, children: [
        ...
        ].map((row, ri) => /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 10, padding: "6px 0", borderTop: ri === 0 ? void 0 : "1px solid var(--dsw-alias-border-l1)" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("svg", { width: "12", height: "12", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", style: { color: "var(--dsw-alias-label-tertiary)", flex: "none" }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("path", { d: "M2.5 8.5a5.5 5.5 0 1 1 11 0 5.5 5.5 0 0 1-11 0Z", stroke: "currentColor", strokeWidth: "1.3" }),
            /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("path", { d: "M8 5.2V8l2 1.4", stroke: "currentColor", strokeWidth: "1.3", strokeLinecap: "round" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { style: { fontSize: 12, color: "var(--dsw-alias-label-secondary)" }, children: row.label }),
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { style: { marginLeft: "auto", fontSize: 12, fontFamily: "ui-monospace, SFMono-Regular, Menlo, monospace", color: "var(--dsw-alias-label-primary)", fontVariantNumeric: "tabular-nums" }, children: row.value })
        ] }, row.label)) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { style: { marginTop: 12 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { style: sectionTitle, children: "\u7BA1\u7406\u64CD\u4F5C" }),
        /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { style: { display: "flex", gap: 8, paddingTop: 8 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("button", { type: "button", style: outBtn, onClick: onManage, children: [
            /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("svg", { width: "12", height: "12", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("path", { d: "M9 2.5 13.5 7 5 15.5H1.5V12L9 2.5Z", stroke: "currentColor", strokeWidth: "1.4", strokeLinejoin: "round" }) }),
            "\u7BA1\u7406\u4F9B\u5E94\u5546"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("button", { type: "button", style: outBtn, onClick: onJumpDetail, children: [
            /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("svg", { width: "12", height: "12", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("path", { d: "M2.5 4.5h11M2.5 8h11M2.5 11.5h7", stroke: "currentColor", strokeWidth: "1.4", strokeLinecap: "round" }) }),
            "\u67E5\u770B\u65E5\u5FD7"
          ] })
        ] })
      ] })
...
function AccountsTab({ refreshTick, onJumpSignal, onJumpDetail }) {
  const [providers, setProviders] = (0, import_react25.useState)([]);
  const [accounts, setAccounts] = (0, import_react25.useState)({});
  const [usage, setUsage] = (0, import_react25.useState)(null);
  ...
  const drawer = selectedProvider !== null ? /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
    AccountDrawer,
    {
      ...
      onManage: () => {
        setCredentialFor(selectedProvider.id);
      }
    },
    selectedProvider.id
  ) : null;
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { style: { minWidth: 0, display: "flex", flexDirection: "column", gap: 3 }, children: usage2 === null ? /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)(import_jsx_runtime29.Fragment, { children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("span", { style: { display: "flex", alignItems: "baseline", gap: 6, minWidth: 0 }, children: [
                      ...
                      usage2.text !== null && /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("span", { style: { fontSize: 11, color: "var(--dsw-alias-label-tertiary)", fontFamily: "ui-monospace, SFMono-Regular, Menlo, monospace", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }, children: usage2.text })
                    ] }),
                    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { style: { width: 96, flex: "none" }, children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(ProgressBar, { percent: usage2.pct, height: 5 }) })
                  ] }) }),
...
function Workbench({ onClose, closing = false, anchor = null, onCardMouseEnter, onCardMouseLeave, renderTab }) {
  ...
  const tabContent = {
    ...
    accounts: /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(AccountsTab, { onJumpSignal: () => setTab("signal"), onJumpDetail: () => setTab("detail") })
  };
  return /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)(PopoverShell, { solid: true, closing, onClose: close, anchor, size: TAB_SIZES[tab], onCardMouseEnter, onCardMouseLeave, ariaLabel: "\u7528\u91CF\u5DE5\u4F5C\u53F0", children: [
    /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)("div", { className: "psh-head", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("button", { type: "button", className: "psh-close", "aria-label": "\u5173\u95ED", onClick: close, children: /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("svg", { width: "15", height: "15", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("path", { d: "M4 4l8 8M12 4l-8 8", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round" }) }) })
    ] }),
...
function McpRecommendView({ t, recommended, servers, onAdd, onRemove }) {
  const [recCat, setRecCat] = (0, import_react28.useState)("all");
  const [openRecMenu, setOpenRecMenu] = (0, import_react28.useState)(null);
  const [q, setQ] = (0, import_react28.useState)("");
  const [searching, setSearching] = (0, import_react28.useState)(false);
  const [external, setExternal] = (0, import_react28.useState)([]);
  const [resolvingId, setResolvingId] = (0, import_react28.useState)(null);
  const [resolveErr, setResolveErr] = (0, import_react28.useState)(null);
...
function McpServerView({ t, servers, onToggle, onToggleAutostart, onRemove, onAddCustom, onOpenInfo }) {
  const [openMcpMenu, setOpenMcpMenu] = (0, import_react28.useState)(null);
  const stats = [

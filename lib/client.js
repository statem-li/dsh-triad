...
function leadingFor(state) {
  switch (state) {
    case "error":
      return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(import_dsh_client_ui_primitives4.StateDot, { state: "error" });
    case "stopped":
      return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(import_dsh_client_ui_primitives4.StateDot, { state: "warning" });
    default:
      return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(import_dsh_client_ui_primitives4.IconSkillOutline16, { size: 14 });
  }
}
function disclosureLeading(state, open, expandable) {
  if (open) return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(import_dsh_client_ui_primitives4.IconChevronDownOutline14, { className: skillCss.chevron });
  const icon = leadingFor(state);
  if (!expandable) return icon;
  return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)(import_jsx_runtime27.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: skillCss.iconIdle, children: icon }),
    /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(import_dsh_client_ui_primitives4.IconChevronDownOutline14, { className: `${skillCss.chevron} ${skillCss.chevronHover}` })
  ] });
}
...
function SkillRow({ block, inspect, t }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { className: skillCss.card, "data-tool": "skill", "data-state": model.state, children: [
    /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)(
      "div",
      {
        ...
        ...disclosureProps,
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: skillCss.leading, children: leading }),
          status !== null ? /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: skillCss.visuallyHidden, children: status }) : null,
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: skillCss.title, children: "Skill" }),
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: skillCss.separator, "aria-hidden": true }),
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: model.errorSummary === null ? skillCss.summary : `${skillCss.summary} ${skillCss.errorSummary}`, children: summary })
        ]
      }
    ),
    open ? /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { className: skillCss.bodyWrap, children: [
      /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("section", { className: skillCss.instructionsCard, "aria-label": t("row.instructions"), children: [
        /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { className: skillCss.instructionsHeader, children: t("row.instructions") }),
        /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("pre", { className: skillCss.instructions, "data-error": model.state === "error" || void 0, children: model.output })
      ] }),
      inspect !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("button", { type: "button", className: skillCss.inspectButton, onClick: inspect, children: [
        /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(import_dsh_client_ui_primitives4.IconInspectOutline12, {}),
        "Inspect"
      ] }) : null
    ] }) : null
  ] });
}
var import_react23, import_dsh_client_ui_primitives4, import_jsx_runtime27;
...
function NavPortal({ name, children }) {
  ...
  return (0, import_react_dom.createPortal)(children, slot);
}
...
function MemoryNavApp() {
  ...
  ensureShellStyles();
  const api = (0, import_react8.useMemo)(createMemoryApi, []);
  const t = (0, import_react8.useMemo)(makeT, []);
  const rail = useRail();
  const unread = useUnreadChanges(api);
  const [open, setOpen] = (0, import_react8.useState)(false);
  const [anchor, setAnchor] = (0, import_react8.useState)(null);
  const [initialTab, setInitialTab] = (0, import_react8.useState)("all");
...
function MemoryToggle({ sessionId, t, ...api }) {
  ensureStyles();
  const [enabled, setEnabled] = (0, import_react9.useState)(null);
...
function applyMemoryClient(ctx) {
  ...
  ctx.effect(() => {
    ...
    root.render((0, import_react10.createElement)(MemoryNavApp));
    return () => {
      root.unmount();
    };
...
function BarChart({ data, height = 240, movingAverage = 7, anomalies, onSelectAnomaly }) {
  ...
  const [wrapW, setWrapW] = (0, import_react12.useState)(0);
  (0, import_react12.useEffect)(ensureBarChartStyles, []);
  ...
  const ticks = (0, import_react12.useMemo)(() => niceTicks(maxVal || 1), [maxVal]);
  ...
  const maLine = (0, import_react12.useMemo)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { ref: wrapRef, className: "dsh-bar-chart", style: { position: "relative", paddingTop: 16 }, children: [
    ...
    hover !== null && hoverPoint !== void 0 && typeof document !== "undefined" && (0, import_react_dom3.createPortal)(
...
function useIsMobile() {
  const [mobile, setMobile] = (0, import_react13.useState)(() => isMobileViewport());
...
function useNarrow() {
  const [narrow, setNarrow] = (0, import_react14.useState)(() => window.matchMedia("(max-width: 1150px)").matches);
...
function TrendTab({ range, rangeLabel, onJumpAccounts, onJumpSignal, refreshTick }) {
  const [usage, setUsage] = (0, import_react14.useState)(null);
  const [hours, setHours] = (0, import_react14.useState)([]);
  const [providers, setProviders] = (0, import_react14.useState)([]);
  const [error, setError] = (0, import_react14.useState)(null);
  const [retryTick, setRetryTick] = (0, import_react14.useState)(0);
...
function Heatmap({ cells, onSelect, rows = 5, cellText = "value" }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { children: [
    ...
    hover !== null && typeof document !== "undefined" && (0, import_react_dom4.createPortal)(
...
var STYLE_ID6 = "dsh-usage-search-styles";
var SHEET5 = `
...
function CardHead2({ name, meta }) {
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 10 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { style: { fontSize: 14, lineHeight: "22px", fontWeight: 500, color: "var(--dsw-alias-label-primary)" }, children: name }),
    meta !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { style: { marginLeft: "auto", fontSize: 12, lineHeight: "18px", color: "var(--dsw-alias-label-tertiary)" }, children: meta })
  ] });
}
var thStyle = {
  textAlign: "left",
...
function UsageTab({ range, rangeLabel, refreshTick }) {
  ...
  const [selectedDay, setSelectedDay] = (0, import_react16.useState)(null);
  ...
  (0, import_react16.useEffect)(() => ensureSearchStyle(), []);
  if (error) {
    return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(ErrorCard, { message: error, onRetry: () => setRetryTick((t) => t + 1) });
  }
  if (usage === null) return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { style: { padding: "24px 0", textAlign: "center", fontSize: 13, color: "var(--dsw-alias-label-tertiary)" }, children: "\u52A0\u8F7D\u4E2D\u2026" });
  const now = /* @__PURE__ */ new Date();
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { style: { display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 8, alignItems: "start" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { style: rowCard2, children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(CardHead2, { name: `${year} \u5E74 ${month} \u6708\u70ED\u529B`, meta: "\u70B9\u51FB\u683C\u5B50\u770B\u5F53\u65E5\u6A21\u578B\u660E\u7EC6" }),
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Heatmap, { cells: monthCells, onSelect: (c) => setSelectedDay(c.label), cellText: "both" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { style: rowCard2, children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(CardHead2, { name: `${year} \u5E74\u5EA6\u70ED\u529B`, meta: "1-6 \u6708 / 7-12 \u6708" }),
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Heatmap, { cells: yearCells, rows: 2, cellText: "both" })
      ] })
    ] }),
    selectedDay !== null && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { style: rowCard2, children: [
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(CardHead2, { name: `${selectedDay} \u6A21\u578B\u660E\u7EC6` }),
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(DayDetailTable, { day: usage.find((d) => d.date === selectedDay) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { style: rowCard2, children: [
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(CardHead2, { name: "\u6A21\u578B\u6D88\u8017\u6392\u884C", meta: `${rangeLabel} \xB7 Top ${Math.min(10, modelRankData.length)}` }),
      modelRankData.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { style: { border: "1px dashed var(--dsw-alias-border-l3)", borderRadius: 8, padding: 12, textAlign: "center", fontSize: 12, lineHeight: "18px", color: "var(--dsw-alias-label-tertiary)" }, children: "\u8BE5\u8303\u56F4\u6682\u65E0\u7528\u91CF" }) : /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(RankBars, { rows: modelRankData, nameWidth: 220 })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { style: rowCard2, children: [
      /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { style: { fontSize: 14, lineHeight: "22px", fontWeight: 500, color: "var(--dsw-alias-label-primary)" }, children: "\u6BCF\u65E5\u660E\u7EC6" }),
        /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("span", { style: { fontSize: 12, lineHeight: "18px", color: "var(--dsw-alias-label-tertiary)" }, children: [
          rangeLabel,
          " \xB7 ",
          searching ? `\u547D\u4E2D ${detailRows.length} \u884C` : `${filteredSorted.length} \u5929`
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("span", { style: { marginLeft: "auto", display: "inline-flex", alignItems: "center", gap: 6, minWidth: 0 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("svg", { width: "12", height: "12", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", "aria-hidden": "true", style: { flex: "none", color: "var(--dsw-alias-label-tertiary)" }, children: [
          ...
          query !== "" && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
            "button",
            {
              type: "button",
              "aria-label": "\u6E05\u9664\u641C\u7D22",
      ...
      filteredSorted.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { style: { border: "1px dashed var(--dsw-alias-border-l3)", borderRadius: 8, padding: 12, textAlign: "center", fontSize: 12, lineHeight: "18px", color: "var(--dsw-alias-label-tertiary)" }, children: "\u8BE5\u8303\u56F4\u6682\u65E0\u7528\u91CF" }) : detailRows.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { style: { border: "1px dashed var(--dsw-alias-border-l3)", borderRadius: 8, padding: 12, textAlign: "center", fontSize: 12, lineHeight: "18px", color: "var(--dsw-alias-label-tertiary)" }, children: [
        "\u6CA1\u6709\u5339\u914D\u300C",
        query.trim(),
        "\u300D\u7684\u4F9B\u5E94\u5546\u6216\u6A21\u578B"
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { style: { maxHeight: 320, overflowY: "auto" }, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("table", { style: { width: "100%", borderCollapse: "collapse" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("thead", { style: { position: "sticky", top: 0, background: "var(--dsw-alias-bg-layer-2)", zIndex: 1 }, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("tr", { children: (searching ? ["\u65E5\u671F", "\u6A21\u578B", "\u8F93\u5165", "\u8F93\u51FA", "\u7F13\u5B58", "\u5408\u8BA1", "\u547D\u4E2D\u7387"] : ["\u65E5\u671F", "\u8F93\u5165", "\u8F93\u51FA", "\u7F13\u5B58", "\u5408\u8BA1", "\u547D\u4E2D\u7387"]).map((h) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("th", { style: thStyle, children: h }, h)) }) }),
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("tbody", { children: detailRows.map((r) => /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(
          "tr",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("td", { style: tdStyle, children: r.date }),
              r.model !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("td", { style: { ...tdStyle, maxWidth: 240, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, title: r.model, children: r.model }),
              /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("td", { style: tdMono, children: formatUnits(r.input) }),
              /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("td", { style: tdMono, children: formatUnits(r.output) }),
              /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("td", { style: tdMono, children: formatUnits(r.cache) }),
              /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("td", { style: tdMono, children: formatUnits(r.total) }),
              /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("td", { style: tdStyle, children: formatHitRate(r.hitRate) })
            ]
          },
          r.key
        )) })
...
function DayDetailTable({ day }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("table", { style: { width: "100%", borderCollapse: "collapse" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("tr", { children: ["\u6A21\u578B", "\u8F93\u5165", "\u8F93\u51FA", "\u7F13\u5B58", "\u5408\u8BA1", "\u547D\u4E2D\u7387"].map((h) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("th", { style: thStyle, children: h }, h)) }) }),
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("tbody", { children: rows.map((r) => /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("tr", { style: { borderBottom: "1px solid var(--dsw-alias-border-l1)" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("td", { style: tdStyle, children: r.model }),
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("td", { style: tdMono, children: formatUnits(r.inputTokens) }),
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("td", { style: tdMono, children: formatUnits(r.outputTokens) }),
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("td", { style: tdMono, children: formatUnits(r.cacheReadTokens) }),
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("td", { style: tdMono, children: formatUnits(r.tokens) }),
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("td", { style: tdStyle, children: formatHitRate(r.cacheHitRate) })
    ] }, r.model)) })
  ] });
}
...
function SignalTab() {
  const [signal, setSignal] = (0, import_react17.useState)(null);
  const [error, setError] = (0, import_react17.useState)(null);
  const [retryTick, setRetryTick] = (0, import_react17.useState)(0);
  const [openDate, setOpenDate] = (0, import_react17.useState)(null);
  const [dayRows, setDayRows] = (0, import_react17.useState)(null);
  const [dayLoading, setDayLoading] = (0, import_react17.useState)(false);
  const [dayError, setDayError] = (0, import_react17.useState)(null);
  const [budgetDraft, setBudgetDraft] = (0, import_react17.useState)("");
  const [budgetSaving, setBudgetSaving] = (0, import_react17.useState)(false);
  const [budgetNote, setBudgetNote] = (0, import_react17.useState)(null);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { style: editorFace, children: [
      /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { style: { display: "grid", gridTemplateColumns: "repeat(5, minmax(0, 1fr))" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Stat, { first: true, label: "\u6A21\u578B\u5C1D\u8BD5\u6B21\u6570", value: formatUnits(efficiency.requests), exact: formatExact(efficiency.requests) }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Stat, { label: "\u7F13\u5B58\u547D\u4E2D\u7387", value: formatHitRate(efficiency.cacheHitRate) }),
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
          Stat,
          {
            label: "\u538B\u7F29\u5360\u6BD4",
      ...
      topRoutesText !== "" && /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { style: { marginTop: 10, fontSize: 11, lineHeight: "16px", color: "var(--dsw-alias-label-tertiary)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: [
        "Top \u6A21\u578B\uFF1A",
        topRoutesText
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { style: rowCard, children: [
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(CardHead, { name: "\u7528\u91CF\u4FE1\u53F7", meta: `\u8FD1 ${sig.activeDays} \u4E2A\u6D3B\u8DC3\u65E5\u53C2\u4E0E\u57FA\u7EBF` }),
      /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { style: { display: "grid", gridTemplateColumns: "repeat(5, minmax(0, 1fr))" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Stat, { first: true, label: "7 \u65E5\u65E5\u5747", value: formatUnits(sig.dailyAvg7), exact: formatExact(Math.round(sig.dailyAvg7)) }),
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Stat, { label: "\u9884\u8BA1 30 \u65E5", value: formatUnits(sig.projected30), exact: formatExact(Math.round(sig.projected30)) }),
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Stat, { label: "\u6628\u65E5\u7528\u91CF", value: formatUnits(sig.yesterdayTokens), sub: sig.yesterdayDate }),
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Stat, { label: "\u6628\u65E5 vs \u4E2D\u4F4D\u6570", value: multipleOf(sig.yesterdayMultiple) }),
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Stat, { label: "\u6D3B\u8DC3\u65E5\u4E2D\u4F4D\u6570", value: sig.activeMedian === null ? "\u2014" : formatUnits(sig.activeMedian) })
      ] }),
      anomalies.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: anomalies.map((day) => /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { role: "alert", style: {
        display: "flex",
        alignItems: "center",
        gap: 10,
        flexWrap: "wrap",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { style: { width: 8, height: 8, borderRadius: 4, flex: "none", background: "var(--dsw-alias-state-error-primary)" } }),
        /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("span", { style: { fontSize: 12, lineHeight: "18px", color: "var(--dsw-alias-label-primary)" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { style: { fontFamily: MONO3, fontWeight: 600, color: "var(--dsw-alias-state-error-primary)" }, children: day.date }),
          " ",
          "\u4F7F\u7528 ",
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { style: { fontFamily: MONO3, fontWeight: 600, color: "var(--dsw-alias-state-error-primary)" }, children: formatUnits(day.tokens) }),
          " ",
          "Token\uFF0C\u662F\u6D3B\u8DC3\u65E5\u4E2D\u4F4D\u6570\u7684",
          " ",
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { style: { fontFamily: MONO3, fontWeight: 600, color: "var(--dsw-alias-state-error-primary)" }, children: multipleOf(day.multiple) }),
          " ",
          "\u500D"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("button", { type: "button", onClick: () => toggleDay(day.date), style: {
          marginLeft: "auto",
          height: 28,
          padding: "0 10px",
      ...
      openDate !== null && /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { style: { borderRadius: 12, background: "var(--dsw-alias-bg-module-platform)", padding: "10px 14px", display: "flex", flexDirection: "column", gap: 6 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { style: { fontSize: 12, lineHeight: "18px", color: "var(--dsw-alias-label-secondary)" }, children: [
          openDate,
          " \u7684\u4F1A\u8BDD\u7528\u91CF\uFF08\u6309 Token \u964D\u5E8F",
          dayLoading ? " \xB7 \u52A0\u8F7D\u4E2D\u2026" : "",
          "\uFF09"
        ] }),
        dayError !== null && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { style: { fontSize: 12, lineHeight: "18px", color: "var(--dsw-alias-state-error-primary)" }, children: dayError }),
        dayRows !== null && dayRows.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { style: { fontSize: 12, lineHeight: "18px", color: "var(--dsw-alias-label-tertiary)" }, children: "\u8BE5\u65E5\u6CA1\u6709\u53EF\u7528\u91CF\u8BB0\u5F55\u3002" }),
        dayRows !== null && dayRows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 10, padding: "6px 0", borderTop: "1px solid var(--dsw-alias-border-l1)", minWidth: 0 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { style: { fontSize: 13, lineHeight: "20px", color: "var(--dsw-alias-label-primary)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: row.title ?? "\u672A\u547D\u540D\u4F1A\u8BDD" }),
          row.firstAt !== null && row.lastAt !== null && /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("span", { style: { flex: "none", fontSize: 11, fontFamily: MONO3, color: "var(--dsw-alias-label-tertiary)" }, children: [
            clockOf(row.firstAt),
            "\u2013",
            clockOf(row.lastAt)
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("button", { type: "button", title: `\u590D\u5236\u4F1A\u8BDD ID\uFF1A${row.id}`, onClick: () => {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { style: { marginLeft: "auto", flex: "none", fontSize: 12, fontFamily: MONO3, color: "var(--dsw-alias-label-primary)" }, children: formatUnits(row.tokens) }),
          /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("span", { style: { flex: "none", fontSize: 11, color: "var(--dsw-alias-label-tertiary)" }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { style: rowCard, children: [
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(CardHead, { name: "30 \u65E5 Token \u9884\u7B97", meta: "\u4FDD\u5B58\u5728\u672C\u673A DSH \u8BBE\u7F6E\u4E2D" }),
      /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("button", { type: "button", disabled: budgetSaving, onClick: saveBudget, style: {
          height: 32,
          padding: "0 16px",
          borderRadius: 16,
        ...
        budgetNote !== null && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { style: { fontSize: 12, lineHeight: "18px", color: budgetNote.ok ? "var(--dsw-alias-state-success-primary)" : "var(--dsw-alias-state-error-primary)" }, children: budgetNote.text })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { style: { fontSize: 11, lineHeight: "16px", color: "var(--dsw-alias-label-tertiary)" }, children: [
        "\u9884\u7B97\u6309\u81EA\u7136\u6708\u6EDA\u52A8\u5BF9\u7167\u300C\u9884\u8BA1 30 \u65E5 Tokens\u300D\u4F30\u7B97\uFF1B\u586B 0 \u53EF\u5173\u95ED\u3002\u5F53\u524D\uFF1A",
        budgetActive ? `${formatUnits(budget)} Token` : "\u5C1A\u672A\u8BBE\u7F6E\u9884\u7B97"
      ] }),
      budgetActive && sig.projected30 > 0 && /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { style: { height: 6, borderRadius: 3, background: "var(--dsw-alias-bg-module-platform)", overflow: "hidden" }, children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { style: {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { style: { fontSize: 12, lineHeight: "18px", color: budgetOver ? "var(--dsw-alias-state-error-primary)" : "var(--dsw-alias-label-secondary)" }, children: budgetOver ? `\u6309\u8FD1 7 \u65E5\u8282\u594F\uFF0C\u9884\u8BA1 30 \u65E5\u7528\u91CF\uFF08${formatUnits(sig.projected30)}\uFF09\u5C06\u8D85\u51FA\u9884\u7B97 ${Math.round((sig.projected30 / budget - 1) * 100)}%` : `\u9884\u8BA1 30 \u65E5\u7528\u91CF\u7EA6\u4E3A\u9884\u7B97\u7684 ${Math.round(budgetUsed * 100)}%` })
      ] })
    ] })
  ] });
}
...
function ProgressBar({ percent, height = 6, dangerBelow = 20, warnBelow = 40 }) {
  const color = percent <= dangerBelow ? "var(--dsw-alias-state-error-primary)" : percent <= warnBelow ? "var(--dsw-alias-state-warn-primary)" : "var(--dsw-alias-state-success-primary)";
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("div", { style: { width: "100%", height, borderRadius: height / 2, background: "var(--dsw-alias-border-l2)", overflow: "hidden" }, children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("div", { style: { height: "100%", width: `${Math.max(0, Math.min(100, percent))}%`, background: color, borderRadius: height / 2, transition: "width .3s ease" } }) });
}
...
function ProviderGroup({ provider, onRequireCredential, refreshKey, isLast, onVisibility }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("div", { style: rowStyle(isLast), children: [
    /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("div", { style: headerStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("span", { style: { width: 8, height: 8, borderRadius: 4, background: statusColor, flex: "none" } }),
      /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("span", { style: nameStyle, children: provider.displayName }),
      provider.accountMode !== null && /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("span", { style: modeTagStyle, children: provider.accountMode === "subscription" ? "\u8BA2\u9605" : "\u4F59\u989D" }),
      hasAlert && /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("span", { style: alertStyle(level), children: [
        "\u26A0 ",
        level === "critical" ? `\u5269\u4F59 ${account?.alert?.value ?? provider.alert?.value ?? 0}%` : `\u5269\u4F59 ${account?.alert?.value ?? provider.alert?.value ?? 0}%`
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("span", { style: metaStyle, children: [
        !needsCredential && /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("span", { style: { fontSize: 11, color: "var(--dsw-alias-label-tertiary)" }, children: [
          "\u66F4\u65B0\u4E8E ",
          account?.fetchedAt ? relativeTime2(account.fetchedAt) : "\u2014"
        ] }),
        !needsCredential && /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("button", { type: "button", onClick: () => load(true), style: refreshButtonStyle, children: "\u5237\u65B0" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("div", { style: bodyStyle, children: needsCredential ? /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("button", { type: "button", onClick: () => onRequireCredential(provider.id), style: credentialButtonStyle, children: "\u914D\u7F6E\u51ED\u636E" }) : loading ? /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("div", { style: { height: 5, borderRadius: 3, background: "var(--dsw-alias-border-l2)", overflow: "hidden", maxWidth: 480 }, children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("div", { style: { width: "40%", height: "100%", background: "var(--dsw-alias-border-l1)", animation: "pulse 1.2s infinite" } }) }) : error ? /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("div", { style: { fontSize: 12, color: "var(--dsw-alias-state-error-primary)", display: "flex", alignItems: "center", gap: 8 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("span", { style: { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", minWidth: 0 }, children: error }),
      /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("button", { type: "button", onClick: () => load(true), style: { border: "none", background: "transparent", color: "var(--dsw-alias-state-error-primary)", cursor: "pointer", fontSize: 12, flex: "none" }, children: "\u91CD\u8BD5" })
    ] }) : account === null ? /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("div", { style: { fontSize: 12, color: "var(--dsw-alias-label-tertiary)" }, children: "\u7B49\u5F85\u9996\u6B21\u83B7\u53D6\u2026" }) : hasWindows ? /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 8, maxWidth: 560 }, children: account.windows.map((w) => /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("div", { style: windowHeaderStyle, children: [
        /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("span", { style: { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", minWidth: 0 }, children: w.kind }),
        /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("span", { style: { flex: "none" }, children: [
          "\u5DF2\u7528 ",
          w.usedPercent,
          "%",
          w.resetsAt ? ` \xB7 ${relativeTime2(new Date(w.resetsAt).getTime())}\u91CD\u7F6E` : ""
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(ProgressBar, { percent: w.remainingPercent, height: 4 })
    ] }, w.kind)) }) : /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("div", { style: planStyle, children: [
      "plan: ",
      /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("span", { style: { color: "var(--dsw-alias-label-primary)" }, children: plan })
    ] }) })
  ] });
}
...
var CRED_STYLE_ID = "dsh-cred-card-solid-styles";
var CRED_SHEET = [
...
function ensureCredSolidStyles() {
  if (typeof document === "undefined") return;
...
var bodyStyle2 = { display: "flex", flexDirection: "column", gap: 12, padding: 16 };
var inputStyle = {
  width: "100%",
  boxSizing: "border-box",
  padding: "6px 10px",
...
function CredentialModal({ providerName, onClose, onSave }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { style: overlayStyle, onClick: onClose, children: /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { style: cardStyle, className: "dsh-webui-cred-card", "data-solid": "", onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { style: headerStyle2, children: [
      /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("span", { children: [
        "\u914D\u7F6E ",
        providerName,
        " \u51ED\u636E"
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("button", { type: "button", "aria-label": "\u5173\u95ED", onClick: onClose, style: { border: "none", background: "transparent", color: "var(--dsw-alias-label-secondary)", cursor: "pointer", fontSize: 15 }, children: "\u2715" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { style: bodyStyle2, children: [
      /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { style: { fontSize: 12, color: "var(--dsw-alias-label-secondary)" }, children: "\u8F93\u5165 API Key\uFF08\u4EC5 SENSENOVA_* \u5F15\u7528\u53EF\u5199\uFF0C\u5B58\u4E8E\u5B89\u5168\u51ED\u636E\u5B58\u50A8\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("input", { type: "password", value, onChange: (e) => setValue(e.target.value), placeholder: "API Key", style: inputStyle }),
      error && /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { style: { fontSize: 12, color: "var(--dsw-alias-state-error-primary)" }, children: error }),
      /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { style: { display: "flex", justifyContent: "flex-end", gap: 8 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("button", { type: "button", onClick: onClose, style: btnBase, children: "\u53D6\u6D88" }),
...
function AccountsTab({ refreshTick }) {
  const [providers, setProviders] = (0, import_react20.useState)([]);
  const [credentialFor, setCredentialFor] = (0, import_react20.useState)(null);
  const [refreshing, setRefreshing] = (0, import_react20.useState)(false);
  const [error, setError] = (0, import_react20.useState)(null);
  const [refreshKey, setRefreshKey] = (0, import_react20.useState)(0);
  const [visibility, setVisibility] = (0, import_react20.useState)({});
  const load = () => {
    setError(null);
  ...
  const report = (0, import_react20.useCallback)((id) => (visible) => {
  ...
  if (error) {
    return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(ErrorCard, { message: error, onRetry: load });
  }
  const visibleIds = providers.filter((p) => visibility[p.id] !== false).map((p) => p.id);
  const lastVisibleId = visibleIds[visibleIds.length - 1];
  const allReported = providers.length > 0 && providers.every((p) => visibility[p.id] !== void 0);
  const noneVisible = allReported && visibleIds.length === 0;
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 16 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { style: { display: "flex", justifyContent: "flex-end" }, children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
      "button",
      {
        type: "button",
        onClick: refreshAll,
        ...
        children: refreshing ? "\u5237\u65B0\u4E2D\u2026" : "\u5168\u90E8\u5237\u65B0"
      }
    ) }),
    providers.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { style: { fontSize: 12, color: "var(--dsw-alias-label-tertiary)", padding: "24px 0", textAlign: "center" }, children: "\u52A0\u8F7D\u4F9B\u5E94\u5546\u2026" }) : noneVisible ? /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("div", { style: { border: "1px solid var(--dsw-alias-border-l1)", borderRadius: 12, background: "var(--dsw-alias-bg-layer-1)", padding: "32px 16px", textAlign: "center" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { style: { fontSize: 13, color: "var(--dsw-alias-label-primary)", marginBottom: 4 }, children: "\u6682\u65E0\u53EF\u5C55\u793A\u7684\u4F59\u989D/\u8BA2\u9605\u6570\u636E" }),
      /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { style: { fontSize: 12, color: "var(--dsw-alias-label-tertiary)" }, children: "\u914D\u7F6E\u51ED\u636E\u6216\u4F7F\u7528\u540E\uFF0C\u8FD9\u91CC\u4F1A\u51FA\u73B0\u5BF9\u5E94\u4F9B\u5E94\u5546\u7684\u4F59\u989D\u4E0E\u914D\u989D\u3002" })
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { style: { border: "1px solid var(--dsw-alias-border-l1)", borderRadius: 12, background: "var(--dsw-alias-bg-layer-1)", overflow: "hidden" }, children: providers.map((p) => /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
      ProviderGroup,
      {
        provider: p,
    ...
    credentialFor !== null && /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
      CredentialModal,
      {
...
var STYLE_ID7 = "dsh-usage-range-picker-styles";
var SHEET6 = `
@media (max-width: 767.98px) {
...
function RangePicker({ preset, custom, onChangePreset, onChangeCustom }) {
  ...
  (0, import_react21.useEffect)(() => ensureStyle(), []);
  return /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 6, flexWrap: "wrap" }, children: [
    PRESETS.map((p) => /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("button", { type: "button", className: "webui-range-btn", style: btn(preset === p.key), onClick: () => onChangePreset(p.key), children: p.label }, p.key)),
    preset === "custom" && /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("span", { style: { display: "inline-flex", alignItems: "center", gap: 4 }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("span", { style: { color: "var(--dsw-alias-label-tertiary)", fontSize: 12 }, children: "~" }),
      /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(
        "input",
        {
          type: "date",
...
function Workbench({ onClose, closing = false, anchor = null, onCardMouseEnter, onCardMouseLeave, renderTab }) {
  const [tab, setTab] = (0, import_react22.useState)("trend");
  const [preset, setPreset] = (0, import_react22.useState)("today");
  const [custom, setCustom] = (0, import_react22.useState)(null);
  const close = onClose ?? (() => {
  });
  ...
  const tabContent = {
    trend: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(TrendTab, { range, rangeLabel, onJumpAccounts: () => setTab("accounts"), onJumpSignal: () => setTab("signal") }),
    detail: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(UsageTab, { range, rangeLabel }),
    signal: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(SignalTab, {}),
    accounts: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(AccountsTab, {})
  };
  return /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)(PopoverShell, { solid: true, closing, onClose: close, anchor, size: TAB_SIZES[tab], onCardMouseEnter, onCardMouseLeave, ariaLabel: "\u7528\u91CF\u5DE5\u4F5C\u53F0", children: [
    /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)("div", { style: css2.topbar, children: [
      /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("span", { style: css2.title, children: "\u7528\u91CF\u5DE5\u4F5C\u53F0" }),
      /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("button", { type: "button", style: css2.close, "aria-label": "\u5173\u95ED", onClick: close, children: "\u2715" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)("div", { style: css2.tabNav, children: [
      /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("div", { style: css2.tabGroup, children: NAV.map((item) => /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("button", { type: "button", style: css2.tabItem(tab === item.key), onClick: () => setTab(item.key), children: item.label }, item.key)) }),
      tab !== "accounts" && tab !== "signal" && /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("div", { style: { marginLeft: "auto" }, children: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(
        RangePicker,
        {
          preset,
          custom,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("main", { style: TAB_SIZES[tab].fill === true ? css2.contentFill : css2.content, className: modalStaggerClass, children: renderTab ? renderTab(tab) : tabContent[tab] })
  ] });
}
...
var STYLE_ID8 = "dsh-skill-manager-styles";
var SHEET7 = `
...
function ensureStyles2() {
  if (typeof document === "undefined") return;
  if (document.getElementById(STYLE_ID8) !== null) return;
  const tag = document.createElement("style");
  tag.id = STYLE_ID8;
...
function PresetBall({ id, label, active, dot, title, onSelect }) {
  return /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(
    "button",
    {
      ...
      onClick: onSelect,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: css3.presetBall, "data-dot": dot ? "true" : void 0, children: id === ALL_PRESETS ? /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.IconAgentPresetOutline16, { size: 18, "aria-hidden": "true" }) : ballInitial(label) }),
        /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: css3.presetBallLabel, children: label })
      ]
    }
  );
}
...
function SkillRowItem({ skill, bundleId, enabled, lockedReason, onToggle, onView, onAssign, onRemove, onDelete }) {
  ...
  head.push(
    /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
      "button",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: css3.toggleKnob, "aria-hidden": "true" })
      },
      "toggle"
    )
  );
  if (files.length > 0) {
    head.push(
      /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
        ...
        {
          type: "button",
          className: css3.skillExpand,
          "aria-label": skillT("viewSkillFiles"),
          "aria-expanded": false,
          onClick: () => {
            onView(skill);
          },
          children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.IconFolderOpenOutline16, { size: 14, "aria-hidden": "true" })
        },
        "view"
      )
    );
  ...
  head.push(
    /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("span", { className: css3.skillLabel, title: description, children: [
      /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: css3.skillName, children: skill.name }),
      description !== "" && /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: css3.skillDescription, children: description })
    ] }, "label")
  );
  if (typeof skill.fileCount === "number") {
    head.push(/* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: css3.skillCount, children: skillT("fileCount", { n: skill.fileCount }) }, "count"));
  }
  if ((skill.compatibility ?? "") !== "") {
    head.push(/* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: css3.skillCompat, title: skill.compatibility, children: skill.compatibility }, "compat"));
  }
  if (bundleId !== null) {
    head.push(
      /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.Tooltip, { label: skillT("removeSkill"), side: "bottom", delayMs: 500, children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("button", { type: "button", className: css3.iconAction, "aria-label": skillT("removeSkill"), onClick: () => {
        onRemove?.(skill);
      }, children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.IconCloseOutline16, { size: 14 }) }) }, "remove")
    );
  } else {
    head.push(
      /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.Tooltip, { label: skillT("assignToBundle"), side: "bottom", delayMs: 500, children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("button", { type: "button", className: css3.iconAction, "aria-label": skillT("assignToBundle"), onClick: () => {
        onAssign?.(skill);
      }, children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.IconPlusOutline16, { size: 14 }) }) }, "assign")
    );
  }
  head.push(
    /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.Tooltip, { label: skillT("deleteSkillBtn"), side: "bottom", delayMs: 500, children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("button", { type: "button", className: css3.iconAction, "aria-label": skillT("deleteSkillBtn"), onClick: () => {
      onDelete?.(skill);
    }, children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.IconTrashOutline16, { size: 14 }) }) }, "delete")
  );
  return /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("li", { className: css3.skillItem, children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("div", { className: css3.skillRow, children: head }) });
}
...
function SkillsPanel({ onClose, closing = false, anchor = null, onCardMouseEnter, onCardMouseLeave }) {
  ...
  const [reload, setReload] = (0, import_react24.useState)(0);
  const [expanded, setExpanded] = (0, import_react24.useState)(/* @__PURE__ */ new Set());
  const [viewer, setViewer] = (0, import_react24.useState)(null);
  const [assignTarget, setAssignTarget] = (0, import_react24.useState)(null);
  const [newBundleOpen, setNewBundleOpen] = (0, import_react24.useState)(false);
  const [newBundleName, setNewBundleName] = (0, import_react24.useState)("");
  const [creatingBundle, setCreatingBundle] = (0, import_react24.useState)(false);
  const [renameTarget, setRenameTarget] = (0, import_react24.useState)(null);
  const [renaming, setRenaming] = (0, import_react24.useState)(false);
  const [confirm, setConfirm] = (0, import_react24.useState)(null);
  const [confirming, setConfirming] = (0, import_react24.useState)(false);
  const [install, setInstall] = (0, import_react24.useState)(null);
  const [installName, setInstallName] = (0, import_react24.useState)("");
  const [installDescription, setInstallDescription] = (0, import_react24.useState)("");
  const [installBundleId, setInstallBundleId] = (0, import_react24.useState)(void 0);
  const [installing, setInstalling] = (0, import_react24.useState)(false);
  const [installError, setInstallError] = (0, import_react24.useState)(null);
  const [dropActive, setDropActive] = (0, import_react24.useState)(false);
  const fileInput = (0, import_react24.useRef)(null);
  const [toggles, setToggles] = (0, import_react24.useState)({ skills: {}, bundles: {} });
  const [toggling, setToggling] = (0, import_react24.useState)(/* @__PURE__ */ new Set());
  const [presets, setPresets] = (0, import_react24.useState)([]);
  const [overrides, setOverrides] = (0, import_react24.useState)({});
  const [activePreset, setActivePreset] = (0, import_react24.useState)(ALL_PRESETS);
  const refresh = () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(
    PopoverShell,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(PshBody, { className: css3.modalBody, children: /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: `${css3.panel} ${modalStaggerClass}`, "aria-busy": state.status === "loading", children: [
          /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: css3.presetStrip, role: "group", "aria-label": t("presetStripLabel"), children: [
            /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
              PresetBall,
              {
                id: ALL_PRESETS,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: css3.presetHint, children: [
            /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: css3.presetHintText, children: activePreset === ALL_PRESETS ? t("presetHintAll") : t("presetHintScoped", { name: presets.find((preset) => preset.id === activePreset)?.name ?? activePreset }) }),
            activePreset !== ALL_PRESETS && Object.keys(presetOverride).length > 0 && /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("button", { type: "button", className: css3.presetReset, onClick: resetActivePreset, children: t("presetReset") })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("div", { className: css3.topRow, children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.Tooltip, { label: t("newBundle"), side: "bottom", delayMs: 500, children: /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(
            "button",
            {
              type: "button",
              className: css3.newBundleButton,
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.IconPlusOutline16, { size: 14 }),
                t("newBundle")
              ]
            }
          ) }) }),
          newBundleOpen && /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("form", { className: css3.inlineForm, onSubmit: (event) => {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.Button, { variant: "primary", type: "submit", disabled: creatingBundle || newBundleName.trim() === "", children: t("create") }),
            /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.Button, { variant: "outline", type: "button", disabled: creatingBundle, onClick: () => {
              setNewBundleOpen(false);
            }, children: t("cancel") })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(
            "div",
            {
              className: `${css3.upload} ${dropActive ? css3.uploadActive : ""}`,
              onClick: () => {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.IconFolderOpenOutline16, { size: 16, "aria-hidden": "true" }),
                /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { children: t("uploadHint") }),
                /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
                  "input",
                  {
                    ref: fileInput,
          ...
          install !== null && /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("form", { className: css3.installForm, onSubmit: (event) => {
            void confirmInstall(event);
          }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: css3.installRow, children: [
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
                "input",
                {
                  className: css3.inlineInput,
              ...
              /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("label", { className: css3.bundleSelect, children: [
                /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: css3.visuallyHidden, children: t("installBundle") }),
                /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(
                  "select",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("option", { value: "", children: t("installLoose") }),
                      bundles.map((bundle) => /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("option", { value: bundle.id, children: bundle.name }, bundle.id))
                    ]
                  }
                )
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: css3.installMeta, children: install.archive === true ? t("uploadMeta", { n: 1, folder: install.folderName }) : t("uploadMeta", { n: install.files.length, folder: install.folderName }) })
            ] }),
            install.archive !== true && nameInvalid && /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("p", { className: css3.error, role: "alert", children: t("installNameInvalid") }),
            /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: css3.installActions, children: [
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.Button, { variant: "primary", type: "submit", disabled: installing || install.archive !== true && (trimmedName === "" || nameInvalid), children: t("installConfirm") }),
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.Button, { variant: "outline", type: "button", disabled: installing, onClick: () => {
                setInstall(null);
              }, children: t("installCancel") })
            ] }),
            installError !== null && /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("p", { className: css3.error, role: "alert", children: installError })
          ] }),
          state.status === "loading" ? /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("p", { className: css3.status, children: t("loading") }) : null,
          state.status === "error" ? /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: css3.failure, children: [
            /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("p", { role: "alert", children: t("error") }),
            /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(import_dsh_client_ui_primitives5.Button, { variant: "outline", onClick: refresh, children: [
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.IconRefreshOutline14, {}),
              " ",
              t("retry")
            ] })
          ] }) : null,
          state.status === "ready" && /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(import_jsx_runtime28.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("h3", { className: css3.sectionTitle, children: t("bundlesTitle") }),
            bundles.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("p", { className: css3.status, children: t("bundlesEmpty") }) : /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("ul", { className: css3.bundleList, children: bundles.map((bundle) => {
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("li", { className: css3.bundle, "data-open": open2 ? "true" : void 0, children: [
                renamingThis ? /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("form", { className: css3.inlineForm, onSubmit: (event) => {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.Button, { variant: "primary", type: "submit", disabled: renaming || renameTarget.name.trim() === "", children: t("rename") }),
                  /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.Button, { variant: "outline", type: "button", disabled: renaming, onClick: () => {
                    setRenameTarget(null);
                  }, children: t("cancel") })
                ] }) : /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(import_jsx_runtime28.Fragment, { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: css3.bundleToggle, children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
                    "button",
                    {
                      type: "button",
                      role: "switch",
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("button", { type: "button", className: css3.bundleRow, "aria-expanded": open2, onClick: () => {
                    toggleExpanded(bundle.id);
                  }, children: [
                    /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: css3.bundleName, children: bundle.name }),
                    /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: css3.bundleCount, children: t("skillsCount", { n: bundle.skillCount }) }),
                    /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.IconChevronDownOutline14, { className: css3.chevron, size: 12, "aria-hidden": "true" })
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: css3.bundleActions, children: [
                    /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.Tooltip, { label: t("rename"), side: "bottom", delayMs: 500, children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
                      "button",
                      {
                        type: "button",
                        ...
                        children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.IconEditOutline16, { size: 14 })
                      }
                    ) }),
                    /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.Tooltip, { label: t("delete"), side: "bottom", delayMs: 500, children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
                      "button",
                      {
                        type: "button",
                        className: css3.iconAction,
                        ...
                        children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.IconTrashOutline16, { size: 14 })
                      }
                    ) })
                  ] })
                ] }),
                open2 && /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("ul", { className: css3.skillList, children: bundle.skills.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("li", { className: css3.status, children: t("bundleNoSkills") }) : bundle.skills.map((skill) => /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
                  SkillRowItem,
                  {
                    skill,
                    bundleId: bundle.id,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("h3", { className: css3.sectionTitle, children: t("looseTitle") }),
            loose.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("p", { className: css3.looseEmpty, children: t("looseEmpty") }) : /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("ul", { className: css3.skillList, children: loose.map((skill) => /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
              SkillRowItem,
              {
                skill,
                bundleId: null,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
          import_dsh_client_ui_primitives5.Modal,
          {
            ...
            footer: /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(import_jsx_runtime28.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.Button, { variant: "outline", disabled: confirming, onClick: () => {
                setConfirm(null);
              }, children: t("cancel") }),
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_dsh_client_ui_primitives5.Button, { variant: "primary", disabled: confirming, onClick: () => {
                void confirmDelete();
              }, children: t("delete") })
            ] })
          }
        ),
        viewer !== null && /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
          import_dsh_client_ui_primitives5.Modal,
          {
            open: true,
            onClose: () => {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: css3.viewerLayout, children: [
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("nav", { className: css3.viewerNav, "aria-label": t("viewerNav"), children: skillFileRows(Array.isArray(viewer.skill.files) ? viewer.skill.files : []).map((row, index) => /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(
                "div",
                {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("div", { className: css3.viewerContent, children: viewer.loading === true ? t("previewLoading") : viewer.error !== void 0 ? viewer.error : /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("div", { dangerouslySetInnerHTML: { __html: renderSkillMarkdown(viewer.content ?? "") } }) })
            ] })
          }
        ),
        assignTarget !== null && /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
          import_dsh_client_ui_primitives5.Modal,
          {
            open: true,
            onClose: () => {
            ...
            className: css3.viewerModal,
            contentClassName: css3.viewerBody,
            children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("div", { className: css3.skillList, children: bundles.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("p", { className: css3.looseEmpty, children: t("assignEmpty") }) : bundles.map((bundle) => /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
              "div",
              {
                className: css3.skillRow,
                style: { cursor: "pointer" },
                onClick: () => {
                  void doAssign(assignTarget, bundle.id);
                },
                children: /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("span", { className: css3.skillLabel, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: css3.skillName, children: bundle.name }),
                  /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: css3.skillDescription, children: t("skillsCount", { n: bundle.skillCount }) })
                ] })
              },
              bundle.id
            )) })
...
function UsageWorkbenchEntry() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)(import_jsx_runtime29.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
      NavButton,
      {
        icon: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_dsh_client_ui_primitives6.IconDataOutline16, { size: rail ? 18 : 16 }),
        label: "\u7528\u91CF",
        rail,
        expanded: open,
        onClick: (e) => {
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(Workbench, { closing, onClose: requestClose, anchor })
  ] });
}
function SkillsEntry() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)(import_jsx_runtime29.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
      NavButton,
      {
        icon: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("svg", { width: rail ? 18 : 16, height: rail ? 18 : 16, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true", children: [
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("path", { d: "M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z" }),
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("path", { d: "M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z" })
        ] }),
        label: "\u6280\u80FD",
        rail,
        expanded: open,
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(SkillsPanel, { closing, onClose: requestClose, anchor })
  ] });
}
function UsageSkillsNavApp() {
  ensureNavStyles();
  return /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)(import_jsx_runtime29.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(NavPortal, { name: "usage", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(UsageWorkbenchEntry, {}) }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(NavPortal, { name: "skills", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(SkillsEntry, {}) })
  ] });
}
function apply2(ctx) {
  ctx.effect(() => {
    ...
    root.render(/* @__PURE__ */ (0, import_jsx_runtime29.jsx)(UsageSkillsNavApp, {}));
    return () => {
      root.unmount();
    };
